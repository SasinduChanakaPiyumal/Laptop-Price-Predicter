...
# OPTIMIZED: Extract screen resolution in a single pass instead of 3 separate calls
...
# OPTIMIZED: Apply storage feature extraction in a single pass
# This avoids 5 additional apply() calls by unpacking results directly
