...
def extract_resolution(res_string: str) -> Tuple[int, int, int]:
    import re
...
def model_acc(model: Any, model_name: str = "Model", use_scaled: bool = False) -> Tuple[float, float, float, float]:
    """
